    ...
    <div className="bg-platinum min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-16 grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          ...
          <p className="text-xl text-darkGrey opacity-80">
            Explore powerful statistical tools and resources designed to help
            you analyze data, understand concepts, and master statistical
            methods.
          </p>
            ...
            {[
              {
                ...
                description:
                  "Easy-to-use calculators for hypothesis testing, regression analysis, ANOVA, and more.",
              },
              {
                icon: <PieChart size={48} className="text-turquoise mb-4" />,
                title: "Data Visualization",
                description:
                  "Tools to create professional charts, plots, and visual representations of your data.",
              },
              {
                icon: <BookOpen size={48} className="text-turquoise mb-4" />,
                title: "Learning Resources",
                description:
                  "Comprehensive guides, tutorials, and examples to master statistical concepts.",
              },
            ].map((feature, index) => (
              <div
                key={index}
                className="bg-platinum p-6 rounded-lg text-center hover:shadow-lg transition-shadow"
              >
                {feature.icon}
                <h3 className="text-2xl font-bold text-darkGrey mb-4">
                  {feature.title}
                </h3>
            ...
            {[
              {
                ...
                description:
                  "Perform linear, multiple, and logistic regression with detailed outputs and visualizations.",
              },
              {
                icon: <BarChart size={36} className="text-turquoise" />,
                title: "Hypothesis Testing",
                description:
                  "Conduct t-tests, chi-square tests, and non-parametric tests with step-by-step explanations.",
              },
              {
                icon: <PieChart size={36} className="text-turquoise" />,
                title: "Descriptive Statistics",
                description:
                  "Calculate means, medians, standard deviations, and create summary statistics tables.",
              },
              {
                icon: <Calculator size={36} className="text-turquoise" />,
                title: "Probability Distributions",
                description:
                  "Work with normal, binomial, Poisson, and other probability distributions.",
              },
            ].map((tool, index) => (
              <div
                key={index}
                className="bg-white p-6 rounded-lg flex items-start space-x-4 hover:shadow-lg transition-shadow"
              >
      ...
      <section className="bg-darkGrey text-white py-16 text-center">
        ...
        <p className="text-xl mb-8 opacity-80">
          Access powerful tools and resources to enhance your statistical
          analysis skills.
        </p>
      ...
      <footer className="bg-darkGrey text-white py-8" id="contact">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center space-x-2 mb-4 md:mb-0">
            ...
            <span className="text-lg text-yellow">Data Tools</span>
          </div>
